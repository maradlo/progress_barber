    ...
    <section id="about" className="py-16 bg-gray-100 w-screen">
      <div className="container mx-auto flex items-center justify-center flex-col">
        ...
        Čauko, <br />
          ...
          Rozhodol som sa nechať prácu v korporatnej spoločnosti a ísť si po svojom. Ako rád hovorievam, stále je to hlavne moje hobby ktoré vykonávam s láskou. Hovorí sa, že pokiaľ si ochotný to robiť aj zadarmo, je to to pravé a dlho tomu tak aj bolo.
          Snažím sa na sebe pracovať denno denne a poskytnúť ti službu najvyššej úrovne. <br />
        ...
        <div className="flex mt-6 space-x-4">
          <a href="https://www.facebook.com/progressbarber.sk" target="_blank" rel="noopener noreferrer">
            <FaFacebook className="text-3xl text-black hover:text-orange-500" />
          </a>
          <a href="https://www.instagram.com/progressbarber.sk" target="_blank" rel="noopener noreferrer">
            <FaInstagram className="text-3xl text-black hover:text-orange-500" />
          </a>
          <a href="https://www.youtube.com/channel/UCpfb8jQy96o-iZfm1Bc1eqA" target="_blank" rel="noopener noreferrer">
