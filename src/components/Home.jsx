...
const Home = () => {
  ...
  const openAndyBookio = () => {
    window.open("https://services.bookio.com/progressbarber-and-coll/widget", "_blank");
  }
    ...
    <section id="home" className="h-screen w-screen bg-cover" style={{ backgroundImage: `url(${background})` }}>
      <div className="text-center pt-36">
        ...
        <div className="flex space-x-16 justify-center mt-6">
          <div>
            <button onClick={() => openProgressBookio()} type='button' className="text-2xl ml-4 px-8 py-2 font-bold text-white rounded transition duration-300 ease-in-out focus:outline-none focus:shadow-outline bg-orange-500 border border-orange-500 hover:bg-orange-700 hover:border-orange-700">ProgressBarber</button>
          </div>
          <div>
          <button onClick={() => openAndyBookio()} type='button' className="text-2xl mr-4 px-8 py-2 font-bold text-white rounded transition duration-300 ease-in-out focus:outline-none focus:shadow-outline bg-red-500 border border-red-500 hover:bg-red-700 hover:border-red-700">AndyBarber</button>
          </div>
        </div>
