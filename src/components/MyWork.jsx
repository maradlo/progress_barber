...
const MyWork = () => {
  ...
  '/images/fotka6.jpg',
  '/images/fotka8.jpeg',
  '/images/new/portfolio1.jpg',
  '/images/new/portfolio2.jpg',
  '/images/new/portfolio3.jpg',
  '/images/new/portfolio4.jpg',
  ];

  return (
    <section id='mywork' className="py-8 bg-gray-200 w-screen">
        ...
        <div className="mx-auto  max-w-md">
          <Carousel showThumbs={false} showStatus={false} infiniteLoop={true} autoPlay={true} interval={3000}>
            {imagePaths.map((imagePath, index) => (
              <div key={index}>
                <img className="custom-carousel-image" src={imagePath} alt={`Fotka ${index + 1}`} />
              </div>
            ))}
          </Carousel>
        </div>
